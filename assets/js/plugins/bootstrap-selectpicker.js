    ...
    Selectpicker.prototype = {
      ...
      createDropdown: function() {
        ...
        drop =
          ...
          '<button type="button" class="' + this.options.styleBase + ' select-holder dropdown-toggle" ' + (this.options.display === 'static' ? 'data-display="static"' : '') + 'data-toggle="dropdown"' + autofocus + ' role="combobox" aria-owns="' + this.selectId + '" aria-haspopup="listbox" aria-expanded="false">' +
